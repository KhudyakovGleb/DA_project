# Словарь городских сущностей для определеннея упоминания пзз 
PZZ_DIC = {'ЖИЛЫЕ ЗОНЫ':['жилищный','комунальный','ижс','жилье'],
           'ПРОИЗВОДСТВЕННЫЕ ЗОНЫ':['производство','производственный', 'промыщленность'],
           'ЗОНЫ СЕЛЬСКОХОЗЯЙСТВЕННОГО НАЗНАЧЕНИЯ':['сельскохозяйственный','агропромышленный'],
           'ОБЩЕСТВЕННО-ДЕЛОВЫЕ ЗОНЫ':['деловой', 'офис', 'культурный','библиотека'],
           'ЗОНЫ ИНЖЕНЕРНОЙ И ТРАНСПОРТНОЙ ИНФРАСТРУКТУРЫ':['инженерный','транспорт'],
           'ЗОНЫ РЕКРЕАЦИОННОГО НАЗНАЧЕНИЯ': ['парк', 'зеленый', 'отдых', 'рекреационный'],
           'ЗОНЫ СПЕЦИАЛЬНОГО НАЗНАЧЕНИЯ': ['кладбище', 'отход','военный']}

# сгруппировать значения внутри словаря
GROUPED_DATA = {
    "ПРОИЗВОДСТВЕННЫЕ ЗОНЫ": 0,
    "ОБЩЕСТВЕННО-ДЕЛОВЫЕ ЗОНЫ": 0,
    "ЗОНЫ ИНЖЕНЕРНОЙ И ТРАНСПОРТНОЙ ИНФРАСТРУКТУРЫ": 0,
    "ЗОНЫ РЕКРЕАЦИОННОГО НАЗНАЧЕНИЯ": 0,
    "ЗОНЫ СПЕЦИАЛЬНОГО НАЗНАЧЕНИЯ": 0
}

# Словарь для связи ключей из исходного словаря с категориями
ZONE_MAPPING = {
    "ПРОИЗВОДСТВЕННЫЕ ЗОНЫ": ['П-1', 'П-2', 'П-3'],
    "ОБЩЕСТВЕННО-ДЕЛОВЫЕ ЗОНЫ": ['Д-1', 'Д-2'],
    "ЗОНЫ ИНЖЕНЕРНОЙ И ТРАНСПОРТНОЙ ИНФРАСТРУКТУРЫ": ['И-1', 'ТЖ', 'ТУ'],
    "ЗОНЫ РЕКРЕАЦИОННОГО НАЗНАЧЕНИЯ": ['Р-1', 'Р-2', 'Р-3', 'Р-0', 'ООПТ'],
    "ЗОНЫ СПЕЦИАЛЬНОГО НАЗНАЧЕНИЯ": ['ВО']}

# Списки разрешённых видов использования для зон
ZONES = {
    "ЖИЛЫЕ ЗОНЫ": { 
        ...
        "водный транспорт"
        "стоянки трансопрта общего пользования",
        "связь",
        "недропользование",
        "причалы для маломерных судов",
        "туристическое обслуживание",
        "спортивные базы",
        "оборудование площадки для занятий спортом",
    ...
    "ОБЩЕСТВЕННО-ДЕЛОВЫЕ ЗОНЫ":{
        ...
        "религиозное использование",
        "осуществление религиозных обрядов",
        "религиодное управление и образование",
        "общественное управление",
        "государственное управление",
        "представительская деятельность",
    ...
    "ПРОИЗВОДСТВЕННЫЕ ЗОНЫ": {
        ...
        "научное обеспечение сельского хозяйства"}, # type: ignore
    ...
    "ЗОНЫ ИНЖЕНЕРНОЙ И ТРАНСПОРТНОЙ ИНФРАСТРУКТУРЫ":{
        ...
        "склады",
        "атомная энергетика",
        "втомобилестроительная промышленность",
        "недропользование",
        "причалы для маломерных судов",
        "ремонт автомобилей",
        "автомобильные мойки",
    ...
    "ЗОНЫ РЕКРЕАЦИОННОГО НАЗНАЧЕНИЯ": {
        ...
        "парки культуры и отдыха",
        "объекты культурно-досуговой деятельности",
        "амбураторно-поликлиническое обслуживание",
        "оказание социальной помощи населению",
    ...
    "ЗОНЫ СЕЛЬСКОХОЗЯЙСТВЕННОГО НАЗНАЧЕНИЯ": {
        ...
        "растениеводство", 
        "выращивание зерновых и иных сельскохозйственных культур"
        "овощеводство", 
        ...
        "коммунальное обслуживание",
        "хранение автотранспорта",
        "выпас сельскохозйственных животных"},
